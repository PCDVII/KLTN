...
DATASET_FOLDER = "D:\\Gitdesktop\\KLTN\\pythonFile\\data"
...
if __name__ == "__main__":
    val_dataset = CSIDataset(
        [
            "D:\\Gitdesktop\\WIFI_CSI_based_HAR\\data\\room_1\\1",
        ],
        1024,
        8,
    )

    dl = DataLoader(val_dataset, batch_size=4, shuffle=False, num_workers=0)
